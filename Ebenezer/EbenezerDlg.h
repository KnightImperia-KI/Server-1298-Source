...
public:	
	...
	int  GetKnightsAllBenefactorMembers( int knightsindex, char *temp_buff, int& buff_index, int type=0 );
	...
	void Send_Region(char* pBuf, int len, C3DMap* pMap, int rx, int rz, CUser* pExcept = NULL);
	...
	char	m_epNotice[20][128];
	char	m_upNotice[20][128];
...
// Dialog Data
	...
	virtual BOOL PreTranslateMessage(MSG* pMsg); // Announcements
	protected:
