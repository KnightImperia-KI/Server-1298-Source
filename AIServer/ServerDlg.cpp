...
BOOL CServerDlg::OnInitDialog()
{
	...
	wsprintf(strLogFile, "Log/UserLog-%d-%d-%d.txt", time.GetYear(), time.GetMonth(), time.GetDay());
	...
	wsprintf(strLogFile, "Log/ItemLog-%d-%d-%d.txt", time.GetYear(), time.GetMonth(), time.GetDay());
	...
	if (m_byZone == UNIFY_ZONE)	m_strStatus.Format("UNIFY_ZONE AI SERVER");
	else if (m_byZone == KARUS_ZONE)	m_strStatus.Format("KARUS AI SERVER");
	else if (m_byZone == ELMORAD_ZONE) m_strStatus.Format("ELMORAD AI SERVER");
	else if (m_byZone == BATTLE_ZONE) m_strStatus.Format("BATTLE AI SERVER");
